public class DiningHallSelectorTesting{
  ...
  public static void main (String[] args){
    ...
    System.out.println("DiningHallSelector testing readWellesleyFresh() reads from txt file to create LinkedList<String> of Dish names");
